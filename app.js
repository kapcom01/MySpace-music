...
(function () {
  ...
  // Build identifier — names the commit that introduced this version's *code*, not the
  // current HEAD. A stamp-bump commit on top of this commit may exist to keep the version
  // query string on HTML asset URLs consistent; that commit changes only stamps, not code.
  //
  // Stamp workflow:
  //   1. Write code, leave 'faeae68-2026-07-21' placeholders in index.html ?v= URLs and
  ...
  var BUILD_REVISION = 'faeae68-2026-07-21';
